...
function Contact() {
    ...
    <div className='h-screen flex flex-col justify-center items-center'>
        ...
        <div className='flex'>
            <a href='https://www.facebook.com/FamilyGains/' className='pr-8'><img src={FacebookIcon} id='social-icons'></img></a>
            <a href='https://www.instagram.com/familygainsedu/'><img src={InstagramIcon} id='social-icons'></img></a>
        </div>
    </div>
    )
}
