...
function Home() {
    ...
    <div className='flex flex-col md:flex-row h-screen items-center'>
        <div className='h-screen md:w-1/2 flex flex-col justify-between sm:justify-evenly items-start p-4 sm:p-16'>
            ...
            <p>Raising a family is hard. We make it a little easier, with our educational activities and content to help your kids build acadmic skills, life skills, and positive values all while having fun!</p>
            <button className=' p-4 rounded-full text-white bg-familygainsred'><Link to='/store'>View Store</Link></button>
        </div>
