...
function Home() {
    ...
    <div className='flex flex-col-reverse md:flex-row h-screen justify-center items-center'>
        <div className='h-screen md:w-1/2 flex flex-col justify-start sm:justify-evenly items-start p-4 sm:p-16'>
            ...
            <p className='mb-4 sm:mb-0'>Raising a family is hard. We make it a little easier, with our educational activities and content to help your kids build academic skills, life skills, and positive values all while having fun!</p>
        ...
        <img className='h-2/5 md:h-4/5 lg:h-5/5 p-16' src='https://i.ibb.co/jfQpRtg/Screenshot-2022-11-21-at-8-06-21-PM.png'></img>
    </div>
    )
}
